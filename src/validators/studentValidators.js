...
export const createStudentValidator = [
  ...
  body('representativePhone').optional().trim(),
  body('representativeEmail').optional().trim().isEmail().withMessage('Email del representante inválido'),
...
export const updateStudentValidator = [
  ...
  body('representativeProfession').optional().trim(),
  body('representativePhone').optional().trim(),
  body('representativeEmail').optional().trim().isEmail(),
  body('studentPhotoUrl').optional().trim(),
  body('representativePhotoUrl').optional().trim(),
  body('age').optional().isInt({ min: 0 }),
  body('aula').optional().trim(),
